			...
			<div class="section">
				...
				<div class="services">
					...
					<table class="table">
							...
							<tr >
								<th><h2>Schimbat saboti/ placute frana/ disc	</h2></th>
								<td><h2>20</h2></td>
							</tr>"
							<tr >	
								<th><h2>Reglat frana</h2></th> 
								<td><h2>15</h2></td> 
							</tr>"
							<tr >
								<th><h2>Montat frana</h2></th>
								<td><h2>30</h2></td>
							</tr>"
							<tr >
								<th><h2>Aerisit frana hidraulica</h2></th>
								<td><h2>40</h2></td>
							</tr>"
							<tr >
							...
							<tr >
								<th><h2>Indreptat disc</h2></th> 
								<td><h2>5</h2></td> 
								
							</tr>"
							<tr >
								<th><h2>Scurtat camasa frana hidraulica</h2></th>
								<td><h2>25</h2></td>
								
							</tr>"
							<tr >
								<th><h2>Service etrier hidraulic</h2></th>
								<td><h2>60</h2></td>
								
							</tr>"
							<tr >
								<th><h2>Service maneta hidraulica</h2></th>
								<td><h2>60</h2></td>
